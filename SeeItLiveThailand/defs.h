//ทดสอบ 1111111111111222222222333333333444444444
...
#define StreamingHistoryURLByCatgory @"http://192.168.9.117/seeitlivethailand/api/liveStreamHistories?filters[stream_media][category_id][operator]==&filtersPage=1&filterLimit=30&filters[stream_media][category_id][value]="
...
#define MessageNotFound @"ไม่พบข้อความแล้ว"
#define NotConnect @"Internet Error"
#define ServerError @"Server Error"
#define NoLiveStream @"No Live"
#define NoVideo @"No Video"
#define AlertTitle @"See It Live Thailand"